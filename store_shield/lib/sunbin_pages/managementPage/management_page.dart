...
class _ManagementPageState extends State<ManagementPage> {
  ...
  void _showEditProductDialog(Map<String, dynamic> itm) {
    showDialog(
      ...
      builder: (context) {
        ...
        int price =
            int.tryParse((itm['price'] as String).replaceAll('원', '')) ?? 0;
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (nameCtrl.text.isEmpty || pickedImage == null) {
                            ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: StoreText('상품명과 이미지를 모두 입력해주세요')));
                            return;
                          }
                          final img64 = base64Encode(pickedImage!);
            ...
            onPressed: _items.isEmpty
                ...
                : () => Navigator.of(context)
                    .push(MaterialPageRoute(
                        builder: (_) =>
                            EditManagementPage(socket: socket, items: _items)))
  ...
  Widget _buildProductList() {
    ...
    if (displayed.isEmpty)
      return const Expanded(child: Center(child: StoreText('등록된 제품이 없습니다')));
    return Expanded(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ClipRRect(
                    borderRadius: BorderRadius.circular(8),
                    child: Image.memory(itm['imageBytes'] as Uint8List,
                          ...
                          Column(
                              ...
                              children: [
                                StoreText(
                                  ...
                                  fontSize: 16,
                                  color:
                                      isSufficient ? Colors.blue : Colors.red,
                                ),
                                const SizedBox(height: 4),
